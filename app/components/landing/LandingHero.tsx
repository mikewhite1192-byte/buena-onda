  ...
  return (
    <>
      <style>{`
        ...
        .gradient-mesh {
          background: linear-gradient(135deg, #0d0f14 0%, #1a1207 25%, #0d0f14 40%, #0f1520 60%, #0d0f14 80%, #1a0f07 100%);
      ...
      {/* ── HERO ── */}
      <section className="gradient-mesh relative min-h-screen flex flex-col justify-center overflow-hidden">

        {/* Ambient glow orbs */}
        <div className="absolute top-[10%] left-[20%] w-[500px] h-[500px] rounded-full pointer-events-none opacity-30 blur-[120px]"
          style={{ background: "radial-gradient(circle, rgba(245,166,35,0.3) 0%, transparent 70%)" }} />
        <div className="absolute bottom-[10%] right-[15%] w-[400px] h-[400px] rounded-full pointer-events-none opacity-20 blur-[100px]"
          style={{ background: "radial-gradient(circle, rgba(247,107,28,0.25) 0%, transparent 70%)" }} />

        {/* Content */}
        <div className="relative z-[2] max-w-[1100px] mx-auto px-6 pt-32 pb-16">
        ...
        <div className="hero-fade-in hero-fade-d5 relative z-[2] py-10 border-t border-white/[0.04]">
          <div className="max-w-[900px] mx-auto px-6 text-center">
            ...
            <div className="flex justify-center items-center gap-12 md:gap-16 flex-wrap opacity-50 hover:opacity-70 transition-opacity duration-500">
              {/* Meta */}
              <svg className="h-6" viewBox="0 0 512 512" fill="white"><path d="M256.6 8C116.5 8 8 110.3 8 248.6c0 72.3 29.7 134.8 78.1 177.9 3.4 2.9 5.6 7.2 5.9 11.9l1.2 37.3c.4 12 12.6 19.7 23.6 14.9l41.6-18.4c3.5-1.6 7.5-1.8 11.2-.7 26.7 7.4 55.1 11.4 84.4 11.4 140.1 0 248.6-102.3 248.6-240.6S396.7 8 256.6 8z"/></svg>
              {/* Google */}
