export default function PrivacyPolicy() {
  return (
    <main style={{ maxWidth: 760, margin: "0 auto", padding: "60px 28px 80px", fontFamily: "system-ui,-apple-system,sans-serif", color: "#1c1e21", lineHeight: 1.7 }}>
      ...
      <p><strong>Ad account data.</strong> With your explicit authorization, we access your Meta Ads Manager data and Google Ads account data (spend, leads, ROAS, campaign details, keywords, ad groups) via the Meta Marketing API and Google Ads API. We access only the permissions you grant and only to provide the Service.</p>
      ...
      <h2 style={{ fontSize: 20, fontWeight: 700, marginTop: 36 }}>5. Data Retention</h2>
      ...
      <h2 style={{ fontSize: 20, fontWeight: 700, marginTop: 36 }}>6. Data Security</h2>
      <p>We use industry-standard security measures including encryption in transit (TLS) and at rest, access controls, and regular security reviews. Meta and Google access tokens are encrypted before storage and rotated automatically.</p>

      <h2 style={{ fontSize: 20, fontWeight: 700, marginTop: 36 }}>7. Third-Party Services</h2>
      ...
      <h2 style={{ fontSize: 20, fontWeight: 700, marginTop: 36 }}>8. Your Rights</h2>
      ...
      <h2 style={{ fontSize: 20, fontWeight: 700, marginTop: 36 }}>9. Cookies</h2>
      ...
      <h2 style={{ fontSize: 20, fontWeight: 700, marginTop: 36 }}>10. Children</h2>
      <p>The Service is not directed to children under 13. We do not knowingly collect personal information from children.</p>

      <h2 style={{ fontSize: 20, fontWeight: 700, marginTop: 36 }}>11. Changes to This Policy</h2>
      ...
      <h2 style={{ fontSize: 20, fontWeight: 700, marginTop: 36 }}>12. Contact</h2>
